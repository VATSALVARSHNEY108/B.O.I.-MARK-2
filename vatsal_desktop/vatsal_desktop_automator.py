#!/usr/bin/env python3
"""
BOI (Barely Obeys Instructions) - Intelligent Desktop Automator
...
class BOIAutomator:
    ...
    def understand_command(self, user_input: str) -> Dict:
        ...
        system_prompt = """You are BOI's (Barely Obeys Instructions) command interpreter. Parse commands into structured actions for LOCAL execution only.
...
def main():
    """CLI for BOI (Barely Obeys Instructions) Desktop Automator"""
    
    print("=" * 70)
    print("  BOI (Barely Obeys Instructions) — Intelligent Desktop Automator")
