#!/usr/bin/env python3
"""
BOI (Barely Obeys Instructions) Chatbot - Simple CLI Interface
...
def print_header():
    ...
    print("\n" + "=" * 70)
    print("🤖 BOI (Barely Obeys Instructions) - Intelligent Chatbot")
    print("=" * 70)
...
async def run_chatbot():
    ...
    print("🔧 Initializing BOI chatbot...")
    try:
    ...
    print("\n" + "=" * 70)
    print("Thank you for using BOI (Barely Obeys Instructions)! 👋")
    print("=" * 70 + "\n")
